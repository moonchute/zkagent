...
contract IssueProcessor is Groth16Verifier, IIssueProcessor, BaseProcessorV2 {
    ...
    function processProof(
      IIssueProcessor.IssueProof calldata _proof
        ...
        issueNum = _parseSignalArray(_proof.signals, 13, 15).stringToUint();
        prNum = _parseSignalArray(_proof.signals, 15, 17).stringToUint();
    }

    /* ============ Internal Functions ============ */
    function _parseSignalArray(uint256[17] calldata _signals, uint8 _from, uint8 _to) internal pure returns (string memory) {
