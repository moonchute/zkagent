...
template PRAuthorRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[2][i].in[4] <== eq[1][i].out;
		multi_or[2][i].in[5] <== eq[2][i].out;
		multi_or[2][i].in[6] <== eq[3][i].out;
		multi_or[2][i].in[7] <== eq[4][i].out;
		multi_or[2][i].in[8] <== eq[5][i].out;
		multi_or[2][i].in[9] <== eq[6][i].out;
		multi_or[2][i].in[10] <== eq[7][i].out;
		multi_or[2][i].in[11] <== eq[8][i].out;
		multi_or[2][i].in[12] <== eq[9][i].out;
		multi_or[2][i].in[13] <== eq[10][i].out;
		multi_or[2][i].in[14] <== eq[11][i].out;
		...
		and[39][i].b <== eq[33][i].out;
		states[i+1][35] <== and[39][i].out;
	...
	for (var i = 0; i <= num_bytes; i++) {
		final_state_result.in[i] <== states[i][45];
	}
